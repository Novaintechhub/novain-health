        ...
        <div className="flex h-full">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 overflow-y-auto bg-white">
            <div className="w-full max-w-md">
              ...
              <p className="text-center text-muted-foreground mb-6">Hello, welcome back!</p>

              <div className="flex flex-col items-center mb-6">
                <Avatar className="h-20 w-20 mb-3">
                  <AvatarImage src="https://placehold.co/80x80.png" alt="Tosin Chukwuka" data-ai-hint="woman portrait"/>
                  <AvatarFallback>TC</AvatarFallback>
                </Avatar>
                <p className="font-medium">tosin.c@novain.com</p>
              </div>
                ...
                <div className="flex items-center justify-between w-full">
                    <div className="flex items-center">
                        <Avatar className="h-6 w-6 mr-2">
                            <AvatarImage src="https://placehold.co/24x24.png" alt="Tosin Chukwuka" data-ai-hint="woman portrait"/>
                            <AvatarFallback>TC</AvatarFallback>
                        </Avatar>
                        <div className="text-left">
                            <p className="text-sm font-semibold">Continue as Tosin</p>
                            <p className="text-xs text-muted-foreground">tosin.c@novain.com</p>
                        </div>
                    </div>
              ...
              <p className="text-center text-sm">
                Don't have an account? <Link href="/patient-registration" className="text-cyan-500 font-semibold hover:underline">Sign up</Link>
              </p>
