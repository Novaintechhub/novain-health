          ...
          <Sheet>
            ...
            <SheetContent side="left">
              ...
              <nav className="flex flex-col gap-4 mt-8">
                ...
                <Button asChild type="button" style={{ backgroundColor: '#D90067', color: 'white', borderRadius: '9999px', marginTop: '1rem' }}>
                  <Link href="/emergency-response">Emergency</Link>
                </Button>
                <Link href="/general-login">
                  <Button asChild style={{ backgroundColor: '#46C8F5', color: 'white', borderRadius: '8px', width: '100%' }}>
